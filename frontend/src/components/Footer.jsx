                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            <a href="https://instagram.com/club_ekprayass?utm_medium=copy_link" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-[12px] bg-slate-800/80 flex items-center justify-center hover:bg-[#17c1c8] hover:text-white text-slate-400 transition-all duration-300">
                            ...
                            <a href="https://www.facebook.com/profile.php?id=100075500094241" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-[12px] bg-slate-800/80 flex items-center justify-center hover:bg-[#17c1c8] hover:text-white text-slate-400 transition-all duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5">
